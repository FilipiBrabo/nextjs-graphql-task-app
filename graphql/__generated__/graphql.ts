...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'UsersPermissionsLoginPayload', jwt: string, user: { __typename?: 'UsersPermissionsMe', id: string, username: string, email: string } } };
